...
import com.ym.idcard.reg.FileUtil;
import com.ym.idcard.reg.IDCard;
import com.ym.idcard.reg.NativeOcr;
import com.ym.idcard.reg.StringUtil;
...
public class OcrEngine {
	...
	public Rect getFieldRect() {
		...
		Log.i("Rect","look at rect left = " + localRect.left);
		localRect.top = arrayOfInt[1];
		Log.i("Rect","look at rect top = " + localRect.top);
		localRect.right = arrayOfInt[2];
		Log.i("Rect","look at rect right = " + localRect.right);
		localRect.bottom = arrayOfInt[3];
		Log.i("Rect","look at rect bottom = " + localRect.bottom);
		return localRect;
	}
